		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.php" class="logo">
					<!-- <img src="../assets/img/scanik.png" alt="navbar brand" class="navbar-brand" width="40"> -->
					<b class="text-white">SMKN 1 CIOMAS</b>
				</a>
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi SMKN 1 CIOMAS (<a href="index.php">Muhammad Ilham Ardhanmas </a> | 2023)
					</div>				
				</div>
			</footer>
		</div>
